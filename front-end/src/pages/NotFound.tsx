export default function NotFound() {
  ...
  const url = `/assets/404/${random}.png`;
  return (
    <main>
            ...
            <div className="max-w-lg mx-auto flex-1 flex-row-reverse gap-12 items-center justify-between md:max-w-none md:flex">
                <div className="flex-1 max-w-lg">
                    <img src={url} onError={({ currentTarget }) => {
                      ...
                      currentTarget.src="/assets/404/1.png";
                      }}
                      
                      title="Imagens de Kapwing: https://www.kapwing.com/404-illustrations"
                      aria-hidden/>
                </div>
                <div className="mt-12 flex-1 max-w-lg space-y-3 md:mt-0">
                    ...
                    <p className="text-gray-600">
                        Desculpe, mas a página que você está procurando não foi encontrada ou foi removida.
                    </p>
